...
$htmlContent = file_get_contents("corpoemail.html");
...
require '\xampp\htdocs\dni\contato\vendor\autoload.php';
...
// Configurações do servidor
    ...
    $mailer->setFrom('mesmo email do user', 'Dúvidas');

    // Define o destinatário

    $mailer->addAddress('email do destinatario', 'nome do destinatario');
    ...
    $mailer->Subject   = ('Formulário de Dúvidas');
